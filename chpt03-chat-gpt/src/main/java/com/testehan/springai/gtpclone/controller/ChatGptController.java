...
public class ChatGptController {
    ...
    public ChatGptController(ChatClient.Builder builder) {
        this.chatClient = builder   // right now, ChatMemory has only 1 implementation InMemoryChatMemory. Maybe in the future they will provide some persistend memory
