...
public class PromptConstants {
    ...
    public static final String M04_APARTMENTS_FOUND = "Below are the apartments that are recommended to you. Click on 'Show Contact' to see the owners phone number :).";
