...
public class AddingListingsMain {
    public static void main(String[] args) {
        ...
        try {
            ...
            String endpoint = "https://casa-mia.fly.dev/api/apartments/save";
            String sessionId = "02D2653DA073350165B707E0843DA916";
            ...
            for (Listing listing : root.data) {
                ...
                if (response.getStatusCode() == HttpStatus.OK) {
                    ...
                    System.out.println("Failed to save apartment. Status code: " + response.getStatusCode());
                }
